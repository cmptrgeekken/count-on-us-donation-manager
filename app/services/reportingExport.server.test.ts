...
const summary: NonNullable<ReportingSummaryResult["summary"]> = {
  ...
  track1: {
    grossContribution: "100.00",
    laborDeduction: "5.00",
    materialDeduction: "5.00",
    packagingDeduction: "0.00",
    equipmentDeduction: "0.00",
    podDeduction: "0.00",
    ...
    availableDonationCapacity: "74.00",
    requestedDonation: "54.00",
    donationPool: "54.00",
    retainedByShop: "20.00",
