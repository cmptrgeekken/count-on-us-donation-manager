...
| [ADR-029](adr-029-production-usage-reporting-and-order-lifecycle.md) | Production usage reporting and order lifecycle eligibility | Accepted | July 2026 |
...
ADR-029 (Production usage reporting and order lifecycle eligibility) - extends ADR-001, ADR-002, ADR-008, ADR-013, ADR-019, and ADR-022 with snapshot-based production usage aggregation, cancellation/refund eligibility, and shared lifecycle reconciliation
```
