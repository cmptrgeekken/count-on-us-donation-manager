...
| GDPR compliance topics configured in app config | **Blocked** | `shopify.app.toml` and `shopify.app.phase3.toml` currently do **not** declare `compliance_topics`; tracked by `#87` and `#101` | Add config entries and verify Shopify accepts them |
